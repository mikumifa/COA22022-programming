...
public class Disk {
    ...
    private static class DiskHead {
        ...
        public void seek(int start) {
            ...
            sector=point%SECTOR_PER_TRACK;
            track=(point/SECTOR_PER_TRACK)%TRACK_NUM;
        }
        ...
        public void addPoint() {
            // TODO
            switch (++point){
                case BYTE_PER_SECTOR:point=0;sector++;break;
                case SECTOR_PER_TRACK:sector=0;track++;break;
                case TRACK_NUM:track=0;break;
            }
        }
