...
public class FPUMulTest {
	...
	public void fpuMulTest7(){
		src = new DataType("01001011000110001001011010000000");
		dest = new DataType("00111111011001100110011001100110");
		result = fpu.mul(src, dest);
		assertEquals( "00000000000000000000000000000001", result.toString() );
	}
	@Test
	public void fpuMulTest8(){
		src = new DataType("01001011000110001001011010000000");
		dest = new DataType("00111111011001100110011001100110");
		result = trueFPU.mul(src, dest);
		assertEquals( "00000000000000000000000000000001", result.toString() );
	}
	@Test
